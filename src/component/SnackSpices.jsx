...
const SnackSpices = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/snack_spices") // Update URL based on your API
      .then((response) => {
  ...
  const handleDeleteProduct = (id) => {
    axios
      .delete(`http://localhost:3000/snack_spices/${id}`)
      .then(() => {
  ...
  const handleUpdateProduct = (e) => {
    e.preventDefault();
    axios
      .put(`http://localhost:3000/snack_spices/${productData.id}`, productData)
      .then(() => {
