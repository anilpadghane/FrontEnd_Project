...
const Fruits = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/fruits") // Update URL based on your API
      .then((response) => {
  ...
  const handleDeleteProduct = (id) => {
    axios
      .delete(`http://localhost:3000/fruits/${id}`)
      .then(() => {
  ...
  const handleUpdateProduct = (e) => {
    e.preventDefault();
    axios
      .put(`http://localhost:3000/fruits/${productData.id}`, productData)
      .then(() => {
